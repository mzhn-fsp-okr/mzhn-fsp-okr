  ...
  return (
    <main className="flex flex-col gap-4 px-4">
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="flex items-center gap-8 rounded bg-blue-400 p-8 text-white transition-all hover:brightness-105">
        ...
        <div className="flex items-center gap-8 rounded bg-purple-400 p-8 text-white transition-all hover:brightness-105">
